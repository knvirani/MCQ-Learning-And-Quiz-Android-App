...
public class ExitReadingInterstitialAd {

    private static final String TAG = "ExitReadingInterstitialAd";
    private static InterstitialAd interstitialAd;
    private static int AD_STATUS;
    private static final String placementId = PlacementIds.INTERSTITIAL_IMAGE_ONLY_AD;
    ...
    private static void initializeAdapter (Context context) {
    ...
    public static void initializeAdapter (Context context, boolean activateMediation) {
        ExitReadingInterstitialAd.activateMediation = activateMediation;
    }

    private static boolean shouldFetchNewAd () {
        if (AdController.isExitReadingInterstitialAdAllowed)
    ...
    private static void loadInterstitialAd (Context context) {
        ...
        InterstitialAd.load(context, placementId, adRequest, new InterstitialAdLoadCallback() {
            ...
            public void onAdLoaded(@NonNull @NotNull InterstitialAd interstitialAd) {
                ...
                ExitReadingInterstitialAd.interstitialAd = interstitialAd;
    ...
    public static void requestNewAd (Context context, boolean activateMediation) {
        ...
        if (activateMediation) {
            ...
            if (MediationAdapterStatus.isInitialized) {
                ...
                MakeLog.info(TAG, "Adapter is Already Initialized for Mediation Ad");

                loadInterstitialAd(context);

            } else {

                MakeLog.info(TAG, "Initializing Adapters");
    ...
    private static void printMediationAdapterClassName (ResponseInfo responseInfo) {
        if (responseInfo != null) {
            ...
            if (responseInfo.getMediationAdapterClassName() != null) {
                ...
                if (whoisMediator(responseInfo.getMediationAdapterClassName()) == ExitReadingInterstitialAd.MEDIATION_AD_FROM_FACEBOOK) {
                    MakeLog.info(TAG,  "Mediation Interstitial Ad From Facebook");
                } else if (whoisMediator(responseInfo.getMediationAdapterClassName()) == ExitReadingInterstitialAd.MEDIATION_AD_FROM_ADMOB) {
